...
// ---------------------------------------------------------------------------
// Security mode constants — 0 is invalid and will revert on-chain
// ---------------------------------------------------------------------------
...
// Gas limits — Monad charges gasLimit not gasUsed, keep these tight.
// Current values are calibration ceiling; tighten after first successful
