...
// IDL loading via createRequire — works with esbuild ESM + isolatedModules
const require = createRequire(import.meta.url);
// IDLs are generated by `anchor build` into target/idl/
// Path is relative to the compiled output in dist/ — adjust if build output
// moves. esbuild copies target/idl at build time (add to build.mjs if needed).
const vaultKeyIdl         = require("../../target/idl/vault_key.json");
const guardianMultisigIdl = require("../../target/idl/guardian_multisig.json");
const monasolProtocolIdl  = require("../../target/idl/monasol_protocol.json");

// Type-only imports from generated types — safe with isolatedModules
